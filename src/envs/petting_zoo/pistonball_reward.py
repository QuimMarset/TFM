from envs.petting_zoo.pistonball_mods.pistonball_positions_custom_reward import parallel_env
from gym.envs.registration import EnvSpec
import numpy as np



class PistonBallReward:

    def __init__(self, num_pistons, continuous, time_penalty, alpha, render, seed=None, **kwargs):
        self.env = parallel_env(n_pistons=num_pistons, continuous=continuous, time_penalty=time_penalty, alpha=alpha)
        if render:
