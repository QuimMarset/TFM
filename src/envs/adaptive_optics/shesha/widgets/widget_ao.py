...
from envs.adaptive_optics.shesha.util.tools import plsh, plpyr
...
from envs.adaptive_optics.shesha.widgets.widget_base import WidgetBase, uiLoader

AOWindowTemplate, AOClassTemplate = uiLoader('widget_ao')

from envs.adaptive_optics.shesha.supervisor.compassSupervisor import CompassSupervisor, scons
...
class widgetAOWindow(AOClassTemplate, WidgetBase):
    ...
    def __init__(self, config_file: Any = None, cacao: bool = False,
        ...
        if expert:
            from envs.adaptive_optics.shesha.widgets.widget_ao_expert import WidgetAOExpert
...
if __name__ == '__main__':
    ...
    if arguments["--interactive"]:
        from envs.adaptive_optics.shesha.util.ipython_embed import embed
