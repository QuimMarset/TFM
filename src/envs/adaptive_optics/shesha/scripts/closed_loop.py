...
if __name__ == "__main__":
    ...
    if arguments["--bench"]:
        from envs.adaptive_optics.shesha.supervisor.benchSupervisor import BenchSupervisor as Supervisor
    elif arguments["--brahma"]:
        from envs.adaptive_optics.shesha.supervisor.canapassSupervisor import CanapassSupervisor as Supervisor
    else:
        from envs.adaptive_optics.shesha.supervisor.compassSupervisor import CompassSupervisor as Supervisor
